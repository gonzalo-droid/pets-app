                  ...
                  {canAct && (
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="rounded-md bg-green-600 px-3 py-1.5 text-xs font-medium text-white hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-600 transition-colors"
                      >
                        Aprobar
                      </button>
                      <button
